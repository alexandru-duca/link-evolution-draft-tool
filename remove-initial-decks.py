...
# Step 2: Replace the specified files inside the decks.zib
print("Delete the files inside decks.zib which correspond with the initial decks.")
FILES_TO_DELETE = [
...
for file_name in FILES_TO_DELETE:
    file_path = os.path.join(FILENAME, "decks.zib", file_name)
